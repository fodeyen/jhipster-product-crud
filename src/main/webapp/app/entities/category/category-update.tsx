  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="ayrotekApp.category.home.createOrEditLabel" data-cy="CategoryCreateUpdateHeading">
            Kategori oluştur veya sil
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              />
              <ValidatedField label="Kategori" id="category-categoryName" name="categoryName" data-cy="categoryName" type="text" />
