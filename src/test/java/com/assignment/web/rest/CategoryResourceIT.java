...
class CategoryResourceIT {
    ...
    public static Category createEntity(EntityManager em) {
        Category category = new Category().categoryId(DEFAULT_CATEGORY_ID).categoryName(DEFAULT_CATEGORY_NAME);
        return category;
    }
    ...
    public static Category createUpdatedEntity(EntityManager em) {
        Category category = new Category().categoryId(UPDATED_CATEGORY_ID).categoryName(UPDATED_CATEGORY_NAME);
        return category;
    }
    ...
    void putNewCategory() throws Exception {
        ...
        updatedCategory.categoryId(UPDATED_CATEGORY_ID).categoryName(UPDATED_CATEGORY_NAME);
    ...
    void fullUpdateCategoryWithPatch() throws Exception {
        ...
        partialUpdatedCategory.categoryId(UPDATED_CATEGORY_ID).categoryName(UPDATED_CATEGORY_NAME);
